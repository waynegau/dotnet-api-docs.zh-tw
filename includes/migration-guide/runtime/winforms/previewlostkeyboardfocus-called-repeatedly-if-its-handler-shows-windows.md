### <a name="previewlostkeyboardfocus-is-called-repeatedly-if-its-handler-shows-a-windows-forms-message-box"></a>如果其處理常式會顯示 Windows Form 訊息方塊 PreviewLostKeyboardFocus 會重複呼叫
